...
# 4. Sensitivity (Recall) - CRITICAL for medical ML
...
# 8. Sensitivity vs Specificity Trade-off
...
# Create a second figure for medical interpretation
...
# Balanced Accuracy (mean of Sens + Spec)
