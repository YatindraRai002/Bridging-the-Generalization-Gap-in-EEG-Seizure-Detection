...
BATCH_SIZE = 64
CALIBRATION_FRACTION = 0.2  # 20% for calibration, 80% for final test
EPOCHS_ADAPT = 10
LR_ADAPT = 1e-4
...
def run_patient_adaptation():
    ...
    # 1. Load Data for Target Patient
    ...
    # Split into Calibration (small) and Test (large)
    ...
    # 2. Baseline Performance (Unadapted)
    ...
    # 3. Mode A: Threshold Calibration (Zero Training)
    ...
    # 4. Mode B: Head Calibration (Fine-tuning last layer)
