...
BATCH_SIZE = 128 
EPOCHS = 50  # ✅ Increased from 6 to 50 as recommended
LR = 5e-5

# Early Stopping Config
PATIENCE = 50  # Set to 50 to run full epochs (effectively disabled)
...
def run_improved_training():
    ...
    results = []
    # history_log moved inside loop
    
    # 2. LOSO Loop - Train on Patient_4 through Patient_6
    target_subjects = ['Patient_4', 'Patient_5', 'Patient_6']
    
    for test_subject in target_subjects:
        # Reset history log for each patient to avoid accumulation
        history_log = []
        ...
        # Model with Dropout (already at 0.5 in BaselineCNN)
